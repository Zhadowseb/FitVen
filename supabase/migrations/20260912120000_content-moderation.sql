...
create table if not exists public.content_reports (
  ...
  -- bigint, because social_post.id is `bigint generated by default as
  -- identity`. It is the one id in this schema that is not a uuid, and
  -- declaring this uuid is what Postgres refused the first time this ran.
  target_post_id bigint references public.social_post(id) on delete cascade,
