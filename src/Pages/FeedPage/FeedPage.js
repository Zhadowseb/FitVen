...
import styles from './FeedPageStyle';
...
export default function FeedPage() {
  ...
  // The feed's own header: a title and nothing else. Everything that used to
  // sit above these posts is Home's, and Home is a different tab now.
  const renderFeedHeader = useCallback(
    () => (
      <View style={styles.feedHeader}>
        <ThemedText style={styles.feedTitle} setColor={theme.title}>
          {t("home.feed.title")}
        </ThemedText>
      </View>
    ),
