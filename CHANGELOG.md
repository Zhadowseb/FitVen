...
- **Fire around the avatar of anyone active, cobwebs on anyone who has gone quiet.** Training now, done today or trained within the last three days, and two rings of flames flicker out of step over a warm glow; the live pulse steps aside for them. Nobody who has never trained gathers cobwebs: there was nothing to leave.
